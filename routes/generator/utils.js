...
const weapons = ["0AFB2636-4093-C63B-4EF1-1E97966E2A3E", "63E6C2B6-4A8E-869C-3D4C-E38355226584", "55D8A0F4-4274-CA67-FE2C-06AB45EFDF58", "9C82E19D-4575-0200-1A81-3EACF00CF872","AE3DE142-4D85-2547-DD26-4E90BED35CF7", "EE8E8D15-496B-07AC-E5F6-8FAE5D4C7B1A", "EC845BF4-4F79-DDDA-A3DA-0DB3774B2794", "910BE174-449B-C412-AB22-D0873436B21B", "44D4E95C-4157-0037-81B2-17841BF2E8E3", "29A0CFAB-485B-F5D5-779A-B59F85E204A8",
                 "1BAA85B4-4C70-1284-64BB-6481DFC3BB4E","E336C6B8-418D-9340-D77F-7A9E4CFE0702", "42DA8CCC-40D5-AFFC-BEEC-15AA47B42EDA", "A03B24D3-4319-996D-0F8C-94BBFBA1DFC7", "4ADE7FAA-4CF1-8376-95EF-39884480959B", "C4883E50-4494-202C-3EC3-6B8A9284F00B", "462080D1-4035-2937-7C09-27AA2A5C27A7", "F7E1B454-4AD4-1063-EC0A-159E56B58941", "2F59173C-4BED-B6C3-2191-DEA9B58BE9C7"];
const roundResultKey = ["Bomb defused", "Eliminated"];
const teamID = ["Red", "Blue"]
const gameModes = ["/Game/GameModes/Bomb/BombGameMode.BombGameMode_C","/Game/GameModes/Bomb/QuickPlay_BombGameMode.QuickPlay_BombGameMode_C","/Game/GameModes/NewPlayerExperience/NPEGameMode.NPEGameMode_C", "/Game/GameModes/ShootingRange/ShootingRangeGameMode.ShootingRangeGameMode_C", "/Game/GameModes/SiteRush/SiteRushGameMode_C"]
const roundCeremon = ["CeremonyDefault", "CeremonyFlawless", "CeremonyCloser"]
const charId = [ "5F8D3A7F-467B-97F3-062C-13ACF203C006", "F94C3B30-42BE-E959-889C-5AA313DBA261", "117ED9E3-49F3-6512-3CCF-0CADA7E3823B", "DED3520F-4264-BFED-162D-B080E2ABCCF9", "320B2A48-4D9B-A075-30F1-1F93A9B638FA",
               "707EAB51-4836-F488-046A-CDA6BF494859", "EB93336A-449B-9C1B-0A54-A891F7921D69", "9F0D8BA9-4140-B941-57D3-A7AD57C6B417", "569FDD95-4D10-43AB-CA70-79BECC718B46", "8E253930-4C05-31DD-1B6C-968525494517", "ADD6443A-41BD-E414-F6AD-E58D267F4E95"]
...
module.exports = {
  ...
  generateTeamDTO: function (t, teamBool) {
      ...
      won = (t == "Red" ? teamBool : !teamBool),
      roundsPlayed = casual.integer((from = 13), (to = 24))
  ...
  generateRoundResultDTO: function (r) {
    ...
    roundResObj.defusePlayerLocations = new Array(5)
      .fill()
      .map(() => casual.point);
